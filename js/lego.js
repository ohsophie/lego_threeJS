...
function green_lego(){
  COLOR = GREEN;
  document.getElementById("rectangle").style.backgroundColor = "#249508";
};
  

function yellow_lego(){
  COLOR = YELLOW;
  document.getElementById("rectangle").style.backgroundColor = "#F9FD06";
};


function red_lego(){
  COLOR = RED;
  document.getElementById("rectangle").style.backgroundColor = "#F00E11";
};


function blue_lego(){
  COLOR = BLUE;
  document.getElementById("rectangle").style.backgroundColor = "#1500DB";
};


function cyan_lego(){
  COLOR = CYAN;
  document.getElementById("rectangle").style.backgroundColor = "#00FFEA";
};


function rose_lego(){
  COLOR = ROSE;
  document.getElementById("rectangle").style.backgroundColor = "#FF0096";
};


function orange_lego(){
  COLOR = ORANGE;
  document.getElementById("rectangle").style.backgroundColor = "#F47D07";
};


function lime_lego(){
  COLOR = LIME;
  document.getElementById("rectangle").style.backgroundColor = "#52FF00";
};
...
function create_brick() {
	...
	if (COLOR == undefined) {
		...
		setTimeout(() => { document.getElementById('tooltip').style.display = "none"; }, 1000);
...
function create_cube_brick() {
	...
	setTimeout(() => { document.getElementById('tooltip').style.display = "none"; }, 1000);
		...
		const BRICK_FRONT_GEOMETRY = new BoxGeometry(
			...
			CONFIG.UNIT);
		const BRICK_FRONT = new Mesh(BRICK_FRONT_GEOMETRY, BRICK_MATERIAL);
		BRICK_FRONT.position.z = CONFIG.BRICK_WIDTH / 2;
		const BRICK_REAR = BRICK_FRONT.clone(true);
		BRICK_REAR.position.z = CONFIG.BRICK_WIDTH / -2;
		const BRICK_MIDDLE_GEOMETRY = new BoxGeometry(
			CONFIG.BRICK_WIDTH - CONFIG.UNIT,
			CONFIG.BRICK_WIDTH / 4,
			CONFIG.UNIT / 2);
